...
export default function ProductsPageContent({ searchParams }) {
  ...
  useEffect(() => {
    ...
    setFilters((prev) => ({
      ...prev,
      categories: categoryParam !== "all" ? [categoryParam] : prev.categories,
      sortBy: sortParam,
      onSale: filterParam === "on-sale",
    }));
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(filters.priceRange[0])}</span>
            <span className="text-muted-foreground">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(filters.priceRange[1])}</span>
          </div>
        </div>
      </div>
